  ...
  <el-container class="layout-container-demo">
    <el-container>
      ...
      <el-container>
        <el-header
          :style="
            phone_bool
              ? 'backdrop-filter: blur(0.1rem);font-size: 14px;position: fixed;width: 100%;z-index: 999'
              : 'font-size: 12px;'
          "
        >
          <top_bar />
    ...
    <div>
      <el-drawer
        ...
        :title="null"
        :show-close="false"
        v-model="show_aside_error"
        @close="aside_data.toggleStatus()"
      >
        <div>
          <logo_view />
          <el-menu
