        ...
        <div >
          ...
          <el-menu :collapse="!show_aside"
            ...
            <el-menu-item index="4" >
              <template #title>
                <el-icon>
                  <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1063" width="200" height="200"><path d="M505.173 68.267c244.313 0 442.368 198.055 442.368 442.368S749.486 953.003 505.173 953.003 62.805 754.948 62.805 510.635 260.86 68.267 505.173 68.267z m8.192 404.138c-22.621 0-40.96 18.339-40.96 40.96v172.032c0 22.622 18.339 40.96 40.96 40.96 22.622 0 40.96-18.338 40.96-40.96V513.365c0-22.621-18.338-40.96-40.96-40.96z m0-141.994c-22.621 0-40.96 18.338-40.96 40.96 0 22.621 18.339 40.96 40.96 40.96 22.622 0 40.96-18.339 40.96-40.96 0-22.622-18.338-40.96-40.96-40.96z" fill="#515151" p-id="1064"></path></svg>
                </el-icon>
                <span>关于我们</span>
              </template>
            </el-menu-item>
