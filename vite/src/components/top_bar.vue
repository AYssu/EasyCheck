...
<template>
  ...
  <div class="toolbar">
    ...
    <div class="user_info">
      ...
      <el-switch :size="phone_bool?'small':''"  border-color="grey" :inactive-action-icon="Sunny"  v-model="dark_theme" @click="theme_status().toggleStatus()" >
