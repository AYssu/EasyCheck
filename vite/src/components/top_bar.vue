  ...
  <div class="toolbar">
    <div class="bread_menu">
      <el-icon size="20" style="cursor: pointer" class="el-icon-s-fold">
        <component
          v-if="phone_bool"
          @click="change_aside_status"
          :is="aside_data.status ? Expand : Fold"
        />
    ...
    <div class="user_info">
      ...
      >
      <el-tag
        v-else-if="user_data.token.level === 2"
        size="small"
        round
        effect="light"
        type="warning"
      ...
      >
      <el-tag
        v-else-if="user_data.token.level === 3"
        size="small"
        round
        effect="light"
        type="primary"
      ...
      >
      <el-tag
        v-else-if="user_data.token.level === 4"
        size="small"
        round
        effect="light"
        type="success"
      ...
      >
      <el-tag
        v-else-if="user_data.token.level === 5"
        size="small"
        round
        effect="light"
        type="danger"
